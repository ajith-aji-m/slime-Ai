...
export function HumanizerCanvas({ artifact }: { artifact: CanvasArtifact }) {
  ...
  return (
    <div className="flex h-full min-h-0 flex-col bg-surface-container-lowest">
      ...
      <div className="flex shrink-0 flex-wrap items-center justify-between gap-2 border-b border-glass-line px-3 py-2">
            ...
            <button
              ...
              className={cn(
                ...
                tab === id
                  ...
                  : "text-on-surface-variant hover:bg-glass-hover hover:text-on-surface",
              )}
            >
              {label}
            </button>
    ...
    <button
      ...
      className={cn(
        ...
        on
          ...
          : "border-glass-line text-on-surface-variant hover:text-on-surface",
      )}
    >
      {label}
    </button>
